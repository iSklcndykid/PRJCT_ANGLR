...
class room {
    ...
    getAllRooms(model) {
        return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            let resp = yield roomCtrl.controller.get(req, null, null);
    ...
    createRoom(model) {
        return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            let roomCtrl = model.controller;
            let resp = yield roomCtrl.controller.insert(req, null, null);
    ...
    updateRoom(model) {
        return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            let roomCtrl = model.controller;
            let resp = yield roomCtrl.controller.update(req, null, null);
    ...
    deleteRoom(model) {
        return (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            let roomCtrl = model.controller;
            let resp = yield roomCtrl.controller.remove(req, null, null);
